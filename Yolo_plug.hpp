...
private:
	...
	int m_frames = 0;
	std::string __APP_NAME__="detect";
	cv::Size image_size_;
...
void Yolo::initParams()
{
	...
	// modelconfig
	std::string config_file_path = "/home/zgq/Documents/Tracker/ros/caktin_track/src/detect_nodelet/cfg/yolo.yaml";
	...
	// yoloclassfile="/home/zgq/Documents/model/yolo/coco.names";
	// yoloModelWeights="/home/zgq/Documents/model/yolo/yolov3-tiny.weights";
	// yoloModelConfiguration="/home/zgq/Documents/model/yolo/yolov3-tiny.cfg";
	m_isGpu = true;
